.. PixieDust documentation master file, created by
   sphinx-quickstart on Thu Jan 12 11:26:46 2017.
...
Start by trying PixieDust in a Python notebook. PixieDust is built-in to IBM's `Data Science Experience <http://datascience.ibm.com/>`_. For a quick look at PixieDust, you can sign up for a free trial there, and create a new notebook from URL using this sample: ``https://github.com/ibm-cds-labs/pixiedust/raw/master/notebook/Intro%20to%20PixieDust.ipynb`` 

Develop for PixieDust
---------------------  

Didn't find a what you need? Create your own visualizations or apps using the pixiedust extensibility APIs. If you know HTML and CSS, you can write and deliver amazing graphics without forcing notebook users to type one line of code. Use the shape of the data to control when Pixiedust shows your visualization in a menu.
